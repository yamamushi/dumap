...
<div class="tab">
    <button class="tablinks" onmouseover="hoverMenuItem(event, 'Wiki')" onclick="window.location='http://dual.sh/wiki/'">Wiki</button>
...
<div id="Crafting" class="tabcontent">
    ...
    <p>A crafting calculator for queue planning and estimating total completion times (0.16 Compatible). Maintained by Velenka.</p>
</div>
